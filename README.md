...
```
    ...
    │   └── screenshots/                                # Application screenshots used in README and documentation
    │       ├── fitness.jpg
    │       ├── progress.jpg
    │       ├── screentime.jpg
...
The full development diary can be found in `documents/diary.md`, documenting architectural decisions, feature iterations, and technical refinements throughout the project lifecycle.
