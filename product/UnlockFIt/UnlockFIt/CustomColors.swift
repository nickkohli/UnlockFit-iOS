// CustomColors.swift contains colour utilities and predefined palettes used throughout the app for consistent theming.
import SwiftUI

// Extension to allow initialising Colour from a hex string (e.g., "#FF0000").
extension Color {
    // Initialise a SwiftUI Colour by parsing a hex code (supports optional leading "#").
    init(hex: String) {
...
// CustomColors holds static colour definitions for rings, themes, and badges.
struct CustomColors {
    // Primary gradient end colours for fitness rings.
    ...
    // Secondary gradient start colours for fitness rings.
